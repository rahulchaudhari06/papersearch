      ...
      e: for (var H = 0, G = x.length, bt = G >>> 1; H < bt; ) {
        ...
        if (0 > l(gl, z))
          yn < G && 0 > l(er, gl)
            ? ((x[H] = er), (x[yn] = z), (H = yn))
            : ((x[H] = gl), (x[vn] = z), (H = vn));
        else if (yn < G && 0 > l(er, z)) (x[H] = er), (x[yn] = z), (H = yn);
        else break e;
      }
    }
    return P;
...
function Ic(e, n, t, r, l, o, u, i, s) {
  (xt = !1), (Rr = null), Mc.apply(jc, arguments);
}
function Fc(e, n, t, r, l, o, u, i, s) {
  if ((Ic.apply(this, arguments), xt)) {
    if (xt) {
      var c = Rr;
      (xt = !1), (Rr = null);
...
function qo(e, n, t, r) {
  if (jr) {
    var l = ao(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Ku(e, r);
...
var Ir = null;
function ao(e, n, t, r) {
  if (((Ir = null), (e = Xo(r)), (e = Sn(e)), e !== null))
...
var ut = {
  ...
  Pl = we(lf),
  of = A({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  uf = we(of),
  sf = A({}, ut, {
...
function Pf(e, n) {
  if (jn)
    return e === "compositionend" || (!tu && js(e, n))
      ? ((e = Ds()), (kr = bo = en = null), (jn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ts.forEach(function (t) {
        t !== "selectionchange" && (Af.has(t) || Dl(t, !1, e), Dl(t, !0, e));
      });
...
function na(e) {
  ...
  function S(f, a, d, v) {
    ...
    for (
      var C = (E = null), _ = a, N = (a = 0), B = null, L = d.next();
      _ !== null && !L.done;
      N++, L = d.next()
    ) {
      _.index > N ? ((B = _), (_ = null)) : (B = _.sibling);
    ...
    if (L.done) return t(f, _), F && gn(f, N), E;
    if (_ === null) {
...
function ya(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), il(4, 4, va.bind(null, n, e), t)
  );
}
function wu() {}
function ga(e, n) {
...
function Sa(e, n, t) {
  return Pn & 21
    ? (De(t, n) || ((t = _s()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function bf(e, n, t) {
  ...
  if (Ea(e)) xa(n, l);
    ...
    (t = ra(e, n, l, r)),
      t !== null && ((l = ue()), Oe(t, e, r, l), Ca(t, n, r));
  }
}
function Ea(e) {
  var n = e.alternate;
  ...
  ed = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        _r(4194308, 4, va.bind(null, n, e), t)
      );
    },
...
function No(e, n, t, r, l, o) {
  La(e, n);
  var u = (n.flags & 128) !== 0;
  if (!r && !u) return l && pi(n, t, !1), Ye(e, n, o);
...
function id(e, n, t) {
  ...
  switch ((ou(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (dr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Fo(Le), (Le = null)))),
        To(e, n),
        te(n),
        null
      );
    ...
    case 10:
      return au(n.type._context), te(n), null;
    case 17:
      return de(n.type) && $r(), te(n), null;
    case 19:
...
function cd(e, n) {
  ...
  for (mo = { focusedElem: e, selectionRange: t }, jr = !1, k = n; k !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[yo], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Va(e, n, t) {
  for (var r = (e.mode & 1) !== 0; k !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (k = o)) : Mi(e);
  }
}
function Mi(e) {
  for (; k !== null; ) {
...
function Oe(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(R & 2) || e !== J) &&
      ...
      pe(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((lt = W() + 500), ul && hn()));
}
function pe(e, n) {
...
function Ba(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = io(e)), l !== 0 && ((r = l), (n = Io(e, l)))), n === 1)
    )
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = xu + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
...
function wn(e, n, t) {
  var r = O,
    l = xe.transition;
  try {
    (xe.transition = null), (O = 1), vd(e, n, t, r);
  } finally {
    (xe.transition = l), (O = r);
  }
  return null;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zo(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
vs = Cu;
ys = Tn;
var Nd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, ms, hs, Cu] },
  yt = {
...
function Td() {
  const [e, n] = Qn.useState([]),
    ...
    o = async (i) => {
      const c = await (
          await fetch(
            ` http://export.arxiv.org/api/query?search_query=all:(blockchain OR web3 OR "smart contracts" OR "decentralized finance" OR "cryptocurrency")&start=0&max_results=${i}&sortBy=lastUpdatedDate&sortOrder=descending`
          )
        ).text(),
    ...
    u = (i) => {
      const c = Array.from(i.getElementsByTagName("entry")).map((h) => ({
        title: h.getElementsByTagName("title")[0].textContent,
        published: h
          .getElementsByTagName("published")[0]
          .textContent.split("T")[0],
        pdfLink:
          h.getElementsByTagName("id")[0].textContent.replace("abs", "pdf") +
          ".pdf",
        summary: h.getElementsByTagName("summary")[0].textContent.trim(),
      }));
      n(c);
    };
  return (
        ...
        K.jsxs("header", {
          ...
          children: [
            K.jsx("h1", {
              ...
              children: "Discover the Latest Web3 Research",
            }),
            K.jsx("p", {
              className: "info-text",
              children:
                "Explore the latest research on Blockchain, Web3, DeFi, Crypto and more.",
            }),
            K.jsx("hr", {}),
          ],
        }),
            ...
            K.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  K.jsxs("p", { children: ["Published: ", i.published] }),
                  K.jsx("button", {
                    className: "toggle-button",
                    onClick: () => l(s),
                    children: t === s ? "Hide Summary" : "Show Summary",
                  }),
                  t === s &&
                    K.jsx("div", {
          ...
          children: [
            K.jsxs("p", {
              children: [
                ...
                " Rahul Chaudhari. All rights reserved.",
              ],
            }),
            K.jsxs("p", {
              children: [
...
ec(document.getElementById("root")).render(
  K.jsx(Qn.StrictMode, { children: K.jsx(Td, {}) })
);
